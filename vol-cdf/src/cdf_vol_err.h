/*
 * Purpose: Contains macros to facilitate error reporting for the CDF VOL connector.
 */

#ifndef CDF_VOL_ERR_H_
#define CDF_VOL_ERR_H_
...
#define HDF5_VOL_CDF_ERR_CLS_NAME "HDF5 CDF VOL"
#define HDF5_VOL_CDF_LIB_NAME "HDF5 CDF VOL"
#define HDF5_VOL_CDF_LIB_VER "1.0.0"

#define H5E_OBJECT H5_cdf_obj_err_maj_g
    ...
    do {                                                                                           \
        ...
        if (err_func) {                                                                            \
            if (H5_cdf_err_stack_g >= 0 && H5_cdf_err_class_g >= 0) {                              \
                H5Epush2(H5_cdf_err_stack_g, __FILE__, __func__, __LINE__,                         \
                         H5_cdf_err_class_g, err_major, err_minor, __VA_ARGS__);                   \
            } else {                                                                               \
...
/* Error handling macros for the CDF VOL test suite */
