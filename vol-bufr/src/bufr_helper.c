...
/*
 * Pruned helper implementation:
 * keeps the APIs used by the connector plus bufr_inv_print() for debugging.
 * Standalone demo code was moved to bufr_helper_demo.c.
 */
