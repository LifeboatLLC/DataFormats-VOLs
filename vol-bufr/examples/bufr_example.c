...
#include <hdf5.h>
/*
#define BUFR_VOL_PLUGIN_PATH "<path_to_the connector>"
*/
...
int main()
{
    ...
    dset_id = H5Dopen(group_id, "pressure", H5P_DEFAULT);
    ...
    /* It is safe to use file datatype to read data back since
       ...
       for dataset "pressure". 
       Currently datatype conversion and space subsetting are not available.
    */
    ...
    printf(" \n Number of group attributes is %zu \n", num_attrs);
